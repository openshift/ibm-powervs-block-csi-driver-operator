...
// the CSI Driver
// These are based on https://github.com/openshift/api/blob/831aaaf072a90c489eca2392f9895015e92aee2c/config/v1/types_infrastructure.go#L1698
var (
	endPointKeyToEnvNameMap = map[string]string{
		"IAM": "IBMCLOUD_IAM_API_ENDPOINT",
		// TODO: use IBMCLOUD_RESOURCE_CONTROLLER_API_ENDPOINT instead to stay inline with other projects.
